...
public class FW_ActionBasedControllerManager : MonoBehaviour
{
    ...
    public class ControllerState
    {
        ...
        StateId m_Id;
        /// <summary>
        /// Sets the identifier of the <see cref="ControllerState"/> from all the optional Controller States that the <see cref="FW_ActionBasedControllerManager"/> holds.
        /// </summary>
        public StateId id
        {
            get => m_Id;
